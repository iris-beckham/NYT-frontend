...
const apiKeys = import.meta.env.VITE_NYT_API_KEY.split(" ");
let keyIndex = 0;

// const API_KEY = import.meta.env.VITE_NYT_API_KEY
// const API_KEY_B = import.meta.env.VITE_NYT_API_KEY_B
...
const Archive = ({ searchInputs, loading, setLoading }) => {
  ...
  useEffect(() => {
    const fetchData = async (keys) => {
      const url = `https://api.nytimes.com/svc/archive/v1/${searchInputs.year}/${searchInputs.month}.json?api-key=${keys}`;
